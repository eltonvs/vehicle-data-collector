...
public class ConfigActivity extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    /**
     * @param prefs Preferences
     * @return volumetric efficiency
     */
    public static double getVolumetricEfficiency(SharedPreferences prefs) {
     ...
     *
     * @param prefs Preferences
     * @return GPS Distance Update Period
     */
