...
import br.ufrn.imd.vehicle_data_collector.activities.ConfigActivity;
import br.ufrn.imd.vehicle_data_collector.activities.MainActivity;
import br.ufrn.imd.vehicle_data_collector.io.ObdCommandJob.ObdCommandJobState;
...
public class ObdGatewayService extends AbstractGatewayService {
    ...
    public void startService() throws IOException {
        ...
        if (remoteDevice == null || "".equals(remoteDevice)) {
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_starting), R.drawable.ic_app, true, true, false);
            ...
            showNotification(getString(R.string.notification_action), getString(R.string.service_started), R.drawable.ic_app, true, true, false);
        }
    }
